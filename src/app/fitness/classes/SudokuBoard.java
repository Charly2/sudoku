...
public class SudokuBoard {
    ...
    private void createSudokuBoard (int dimension, int[] cellValues) throws BuilderException {
        ...
        //System.out.println("created a new sudoku: \n\n" + this);
    }
    ...
    public int calculateNonDuplicatedValuesInSquares () {
        ...
        //System.out.println("the sudoku has " + nonDuplicadedValues + " (of " + dimensionHipercubo + ") non duplicated values in the squares");
    ...
    public int calculateNonDuplicatedValuesInLines () {
        ...
        //System.out.println("the sudoku has " + nonDuplicadedValues + " (of " + dimensionHipercubo + ") non duplicated values in the lines");
    ...
    public int calculateNonDuplicatedValuesInColumns () {
        ...
        //System.out.println("the sudoku has " + nonDuplicadedValues + " (of " + dimensionHipercubo + ") non duplicated values in the columns");
        return nonDuplicadedValues;
    }
            ...
            for (int j = 0; j < dimensionCuadrado; j++) {
                ...
                if (templateValues[i][j] != NULL_VALUE) {
                    if (templateValues[i][j] != values[i][j]) {
                        ...
                        //System.out.println("the sudoku don't match with the template!");
                    }
                }
            }
        }
